/* empty css                                     */
import { c as createComponent, r as renderTemplate, b as renderComponent, f as renderScript, m as maybeRenderHead } from '../chunks/astro/server_DvEJYFl4.mjs';
import 'kleur/colors';
import 'html-escaper';
import { $ as $$AuthLayout } from '../chunks/AuthLayout_DQS5BCb2.mjs';
...
Copyright © 2021-${(/* @__PURE__ */ new Date()).getFullYear()} <a href="https://codepen.io/uidesignhub" rel="" target="_blank" title="Ajimon" class="text-green hover:text-green-500">AJI</a></span> </div> </div> </div> ` })} ${renderScript($$result, "/Users/macbook/Documents/astro/07-store/src/pages/register.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/macbook/Documents/astro/07-store/src/pages/register.astro", void 0);

const $$file = "/Users/macbook/Documents/astro/07-store/src/pages/register.astro";
const $$url = "/register";
