...
Copyright © 2021-${(/* @__PURE__ */ new Date()).getFullYear()} <a href="https://codepen.io/uidesignhub" rel="" target="_blank" title="Ajimon" class="text-green hover:text-green-500">AJI</a></span> </div> </div> </div> ` })} ${renderScript($$result, "/Users/macbook/Documents/astro/07-store/src/pages/login.astro?astro&type=script&index=0&lang.ts")}`;
}, "/Users/macbook/Documents/astro/07-store/src/pages/login.astro", void 0);

const $$file = "/Users/macbook/Documents/astro/07-store/src/pages/login.astro";
const $$url = "/login";
